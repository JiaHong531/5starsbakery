...
CREATE TABLE feedback (
    ...
    FOREIGN KEY (product_id) REFERENCES products(product_id),
    FOREIGN KEY (order_id) REFERENCES orders(order_id),
    UNIQUE KEY (user_id, order_id, product_id)
);
...
('Almond London Cookies', 'Crunchy almond cookies coated in chocolate.', 'Flour, Almond, Chocolate', 18.00, 50, 'Cookies', '/product-images/almond_london_cookies_1768035835814.jpg'),
('Apple Cinnamon Muffin', 'Sweet apple muffins with a hint of cinnamon.', 'Flour, Apple, Cinnamon, Sugar', 4.50, 40, 'Muffin', '/product-images/apple_cinnamon_muffin_1768035835825.png'),
('Banana Walnut Muffin', 'Moist banana muffins with crunchy walnuts.', 'Flour, Banana, Walnut, Sugar', 12.00, 25, 'Muffin', '/product-images/banana_walnut_muffin_1768035835830.jpg'),
...
('Blueberry Streusel Muffin', 'Muffin topped with sweet crunchy streusel.', 'Flour, Blueberry, Sugar, Butter', 6.00, 35, 'Muffin', '/product-images/blueberry_streusel_muffin_1768035835836.png'),
...
('Lemon Poppyseed Cake', 'Lemon cake with crunchy poppyseeds.', 'Flour, Lemon, Poppyseeds', 11.00, 30, 'Cake', '/product-images/lemon_poppyseed_cake_1768035835873.jpg'),
('Macadamia White Choc Cookie', 'White chocolate cookies with macadamia.', 'Flour, White Choc, Macadamia', 16.00, 35, 'Cookies', '/product-images/macadamia_white_choc_cookie_1768035835875.jpg'),
...
('Oatmeal Raisin Cookie', 'Healthy oatmeal cookies with raisins.', 'Oats, Raisins, Flour, Sugar', 9.00, 50, 'Cookies', '/product-images/oatmeal_raisin_cookie_1768035835882.jpg'),
...
('Red Velvet Cream Cheese Cake', 'Red velvet cake with cream cheese frosting.', 'Flour, Cocoa, Cream Cheese', 12.00, 35, 'Cake', '/product-images/red_velvet_cream_cheese_cake_1768035835894.jpg'),
('Red Velvet Nuts Cookie', 'Red velvet cookie with crunchy nuts.', 'Flour, Cocoa, Nuts, Sugar', 13.00, 35, 'Cookies', '/product-images/red_velvet_with_nuts_cookie_1768035835896.jpg'),
('Salted Caramel Cupcake', 'Sweet cupcake with salted caramel drizzle.', 'Flour, Caramel, Salt, Sugar', 14.00, 25, 'Cupcake', '/product-images/salted_caramel_cupcake_1768035835900.png'),
('Savory Cheese & Chive Muffin', 'Savory muffins with cheese and chives.', 'Flour, Cheese, Chives, Butter', 7.00, 40, 'Muffin', '/product-images/savory_cheese_chive_muffin_1768035835903.jpg'),
...
('Vanilla Bean Muffin', 'Pure vanilla flavored muffin.', 'Flour, Vanilla Bean, Sugar', 10.00, 30, 'Muffin', '/product-images/vanilla_bean_muffin_1768035835913.jpg'),
...
('French Loaf', 'Traditional French baguette.', 'Flour, Yeast, Water', 7.00, 20, 'Loaves', '/product-images/French Loaf.jpg'),
...
('Ham & Cheese Croissant', 'Classic ham and cheese bun.', 'Flour, Ham, Cheese', 5.50, 35, 'Croissant', '/product-images/Ham & Cheese Croissant.jpg'),
...
('Matcha White Choc Croissant', 'Croissant taste with matcha and white chocolate.', 'Flour, Matcha, White Chocolate', 8.00, 30, 'Croissant', '/product-images/Matcha White Choc Croissant.png'),
...
('Salted Egg Yolk Lava Croissant', 'Molten salted egg yolk filling croissant.', 'Flour, Salted Egg, Butter', 9.00, 25, 'Croissant', '/product-images/Salted Egg Yolk Lava Croissant.jpg'),
...
('White Loaf', 'Classic white loaf.', 'Flour, Milk, Butter', 6.00, 20, 'Loaves', '/product-images/White Loaf.jpg'),
('Whole Wheat Loaf', 'Healthy whole wheat loaf.', 'Whole Wheat Flour, Water', 7.00, 20, 'Loaves', '/product-images/Whole Wheat Loaf.png');
