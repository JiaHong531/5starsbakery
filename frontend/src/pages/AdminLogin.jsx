    ...
    return (
        <div className="flex justify-center items-center min-h-[60vh] px-4">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-[500px]">
                <h2 className="mb-6 text-header-bg text-center text-2xl font-bold">Login as Administrator</h2>
                ...
                <div className="mt-6 flex flex-col items-center gap-2">
                    <Link to="/login" className="text-text-main text-sm hover:underline">Login as User</Link>
                </div>
            </div>
        </div>
    );
