        ...
        <footer className="bg-header-bg text-text-light py-8 mt-auto relative z-50">
            <div className="max-w-[1200px] mx-auto px-5 flex flex-wrap justify-between items-start gap-8">
                ...
                <div className="flex flex-col gap-2.5 animate-slideUp">
                    ...
                    <Link to="/about" className="hover:text-accent-1 transition-all duration-300 font-sans text-base link-underline hover:translate-x-1">About 5 Stars Bakery</Link>
                    <Link to="/privacy-policy" className="hover:text-accent-1 transition-all duration-300 font-sans text-base link-underline hover:translate-x-1">Privacy Policy</Link>
                    <Link to="/terms" className="hover:text-accent-1 transition-all duration-300 font-sans text-base link-underline hover:translate-x-1">Terms & Conditions</Link>
                </div>

                {/* Contact Section - Animated with delay */}
